...
function setup() {
  createCanvas(windowWidth, windowHeight*0.7, WEBGL);
  normalMaterial();
...
<head>
  ...
  <script language="javascript" type="text/javascript" src="mappa.js"></script>
  <script language="javascript" type="text/javascript" src="mountain.js"></script>
  <script language="javascript" type="text/javascript" src="translate.js"></script>
  <script language="javascript" type="text/javascript" src="tree.js"></script>
  <script language="javascript" type="text/javascript" src="sketch_3Dtext02.js"></script>
...
</html>(function webpackUniversalModuleDefinition(root, factory) {
...
// Reference: https://www.mapbox.com/api-documentation/0xstatic
// -----------
  ...
  _createClass(Mapbox, [{
    ...
    value: function messages() {
      return {
        ...
        key: function key() {
          console.error('Mapbox Static API needs a key to work. To get a key visit: https://www.mapbox.com/api-documentation/0xstatic');
        }
      };
    }
  }]);
...
function randomize() {
  ...
  //bgc = color(random(255), random(40, 70), 255) // background int //swc = color(random(255), random(40, 70), 255) // side walk int bhv = random(0, 100) // branch hue value
  ...
  fc = color(fhv, random(0, 255), 255) // flower int rr = random(20, 80) // rotatian range
  ...
  ll = PApplet.parseInt(random(0, 5)) // leaf level
...
class Node {
  constructor(_len, _size, _rot_range, _level) {
    ...
    this.level = _level
    this.lc = color(lhv, lsv, random(100, 255)) // leaf int this.len = this.len * (1 + random(-rl, rl))
    ...
    this.bc = color(bhv, random(170, 255), random(100, 200)) // branch int this.lc = color(lhv, lsv, random(100, 255)); // leaf int this.fb = random(200, 255) // flower brightness
